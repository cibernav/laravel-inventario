    ...
    <div class="col-lg-5 col-xs-12">
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <input type="hidden" value="{{ auth()->user()->name }}" name="_username" id="_username">
                    <div class="box-body">
                        <div class="box">
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                <input type="text" class="form-control" id="name_user" name="name_user" value="{{ Auth::user()->name }}"  readonly>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="serie_doc" name ="serie_doc" value ="1" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-8">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-key"></i></span>
                                            <input type="text" class="form-control" id="num_doc" name="num_doc" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="width: 50%">
                                                    <div class="input-group">
                                                        <input type="number" class="form-control" min="0" id="impuesto" name="impuesto" placeholder="0" value="0">
                                                ...
                                                <td style="width: 50%">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i class="ion ion-social-usd"></i></span>
                                                        <input type="text" class="form-control numeroformato" data-total="0" data-subtotal="0" data-impuesto="0" id="totalventa" name="totalventa" placeholder="0.00" readonly>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
                    ...
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary pull-right" id="btnSaveVenta">Guardar venta</button>
                    </div>
                </form>
            </div>
        </div>
...
$(document).ready(function(){
    ...
    $('#opcionMetodoPago').on('change', 'input#importePagado', function(){
        fnCalculaVuelto(this);
    });

    $('#opcionMetodoPago').on('keypress', 'input#importePagado', function(e){
        if (e.which == 13)
            fnCalculaVuelto(this);
    });
    ...
    $('#frmVenta').submit(function(e){
        ...
        var lista = JSON.stringify(dataListProduct);
...
function fnCalculaVuelto(self){
    var importePagado = Number($(self).val());
...
function fnAddItem(id, product, price, stock){
    if (stock > 0){
        ...
        if (item){
            ...
            dataListProduct.push({ idproduct: id, product : product, price : price, cantidad : cant, stock: stock });
...
function refreshRows(){
    ...
    dataListProduct.forEach(x => {
        var row = addRow(x.idproduct, x.product, x.price, x.cantidad, x.stock );
...
function addRow(id, product, precio, cant, stock){
    var row = `
    <div class="form-group row">
        <!-- Producto -->
        <div class="col-xs-6" style="padding-right:0px">
            <div class="input-group">
                <span class="input-group-addon">
                    <button type="button" class="btn btn-danger btn-xs" data-id="${id}" onclick="return deleteRow(this);">
                            <i class="fa fa-times"></i>
                    </button>
                </span>
        ...
        <!-- Cantidad -->
        <div class="col-xs-3">
            <input type="number" class="form-control" min="1" placeholder="0" id="cantidad" value="${cant}" data-id="${id}" data-stock="${stock}" onchange="return calculateRow(this);">
        </div>
        <!-- Precio -->
        <div class="col-xs-3" style="padding-left:0px">
            <div class="input-group">
...
function deleteRow(self){
    ...
    dataListProduct = dataListProduct.filter(x => x.idproduct != id);
